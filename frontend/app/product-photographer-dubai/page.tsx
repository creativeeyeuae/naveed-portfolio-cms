...
const DESC =
  "Product photographer in Dubai for e-commerce, catalogues and advertising — clean, accurately lit imagery that shows products the way customers expect. By Naveed Anjum, Creative Fusion.";
const URL = "https://bynaveedanjum.com/product-photographer-dubai";
