...
const TITLE = "Architectural Photographer in Dubai | Naveed Anjum";
const DESC =
  "Architectural photographer in Dubai capturing buildings, façades and skylines with clean lines, for architects, developers and design studios.";

export const metadata: Metadata = buildMetadata({
  path: "/architectural-photographer-dubai/",
  title: TITLE,
  description: DESC,
});
